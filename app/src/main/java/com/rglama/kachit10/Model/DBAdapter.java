...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_EMAIL, KEY_FAVCOLOUR,KEY_ADDRESS,KEY_DESCRIPTION};
    ...
    public long insertRow(String name, String email, String favColour,String address, String description) {
		/*
		 * CHANGE 3:
		 */
    ...
    public boolean updateRow(long rowId, String name, String email, String favColour,String address,String description) {
        String where = KEY_ROWID + "=" + rowId;
